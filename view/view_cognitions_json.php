  ...
  for ($i=0; $i<count($cognitions_json); $i++) {
    for ($j=0; $j<USER_SIZE; $j++) {
      ...
      if ($search_index == $user_id) { // userId
          ...
          viewCognitions($cognition_1, $cognition_2, $count_order, $answer_rate, $date, $end_time);
      }
    }
  }
}
...
// 認知課題を表示する
function viewCognitions($cognition_1, $cognition_2, $count_order, $answer_rate, $date, $end_time){
  // 認知課題1
  switch ($cognition_1) {
    case 2:
